...
<template>
  <div> <!-- 添加一个根元素来包裹所有内容 -->
    <el-row class="searchBox article-search"
            style="position: fixed;top: 0.2%;right: 7%;width: 30%;z-index: 999; margin-right: 360px; display:none;">
      <el-col :span="8" :offset="8" style="margin-left: 0px">
        <el-input v-model="queryParams.search" placeholder="请输入文章标题" :maxlength="10"></el-input>
      </el-col>
